            ...
            <div class="col-xs-6 col-sm-6 placeholder">
              <form action="addcomponent.php" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="txtnombre" name="txtnombre" required maxlength="50">
                </div>
                <div class="form-group">
                  <label for="slot" class="control-label">slot</label>
                  <input type="text" class="form-control" id="txtslot" name="txtslot" required maxlength="11">
                </div>
      		  		<div class="form-group">
